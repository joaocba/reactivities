...
interface Props {
    ...
    selectActivity: (id: string) => void; // This is a function that takes a string as an argument and returns void
    cancelSelectActivity: () => void; // This is a function that returns void
    editMode: boolean;
